...
exports.default = WebglHardware;
function WebglHardware() {
  ...
  function getAngle(gl) {
    ...
    const angle = (navigator.platform === 'Win32' || navigator.platform === 'Win64') && gl.getParameter(gl.RENDERER) !== 'Internet Explorer' && gl.getParameter(gl.RENDERER) !== 'Microsoft Edge' && lineWidthRange === describeRange([1, 1]);
